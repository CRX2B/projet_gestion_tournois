...
class Interface:
    ...
    def prompt_nouveau_joueur(self):
        ...
        if date_naissance == "q":
            return self.menu_principal()
        nouveau_joueur = self.controller.nouveau_joueur(nom, prenom, date_naissance)
    ...
    def gestion_round(self):
        """Gère le déroulement d'un round"""
    ...
    def afficher_classement(self):
        ...
        print("\nClassement final :")
        joueurs_tries = sorted(self.controller.tournoi.liste_joueurs, 
                             key=lambda x: (-x.score, x.nom))
